...
- FACT: Library state (2026-08-11, post-overhaul): **123 active skills / 15 plugins**
  (+ 66 skills / 9 plugins archived in `archive/`); `validate.sh` clean; catalog =
  docs/SKILLS.md, quick router = docs/INDEX.md, both generated by gen-catalog.py.
  (Supersedes the 119/18 snapshot below, kept for provenance.)
