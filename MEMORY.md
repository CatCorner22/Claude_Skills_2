...
- DIRECTIVE (user-stated 2026-08-08, standing): **No more Oracle work.** Build nothing new
  ...
  **SUPERSEDED 2026-08-18: those plugins were later DELETED, not archived** — 17 Oracle skills
  and 49 finance/treasury skills removed outright on owner direction, and `archive/plugins/` no
  longer exists. "Preserved, restorable" is no longer true of any of them; the only skill-level
  archives that remain are two under `archive/skills/`. Never write a restore pointer to a
  deleted domain plugin.
