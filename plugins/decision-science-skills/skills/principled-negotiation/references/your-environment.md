# Your negotiation environment (sanitized template)

Fill in your real setup — structure only. Walk-away lines, target prices, live positions,
and anything about a negotiation still in progress belong in
`your-environment.private.md` (git-ignored), never here: a committed walk-away line is a
leaked one.

- **Standing counterparties:** <banks, merchant processors, insurance carriers, key
