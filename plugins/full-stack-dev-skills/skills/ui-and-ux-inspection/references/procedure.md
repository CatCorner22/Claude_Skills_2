...
Preserved verbatim from the source specification.

Contents: Preflight and authorization · Build an interface inventory · Define critical user outcomes · Trace each process backward · Inspect visual hierarchy and scanability · Inspect Gestalt grouping · Inspect choices and progressive disclosure · Inspect affordances and signifiers · Inspect navigation and mental models · Inspect forms · Inspect feedback, state, and recovery · Inspect tables, filters, and search · Inspect onboarding and engagement · Inspect accessibility · Inspect responsive and environmental behavior · Inspect performance · Automated test plan · Human-validation prompts · Eye-tracking inspection mode · Privacy inspection
