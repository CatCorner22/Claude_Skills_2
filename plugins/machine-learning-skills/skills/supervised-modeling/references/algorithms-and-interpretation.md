...
|---|---|---|
| Feature scaling | Standardize before any penalty | L1/L2 penalize coefficients *per unit*, so an unscaled feature measured in cents is penalized 100× harder than the same feature in currency units. Symptom of skipping it: the regularization path drops your best feature first |
