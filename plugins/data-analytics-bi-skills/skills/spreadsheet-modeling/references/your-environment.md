...
- **Input-cell standard:** <e.g. blue font, light-yellow fill for assumptions>
- **Sheet-structure convention:** <one sheet with three zones | separate Inputs/Calcs/Outputs sheets>
- **Standard check cells:** <cross-foot, balance check, reconciliation to source, master OK/ERROR flag>
- **Named-range conventions:** <what gets named, scoping, prefixes>
