...
the archived `continuous-improvement-skills:value-stream-mapping` (map it) and
...
**MSCD linguistic failures.** The house four (shared with the archived `coding-agent-skills:script-wizard`
